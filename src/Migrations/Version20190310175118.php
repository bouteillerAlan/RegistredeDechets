 ...
 */
final class Version20190310175118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE emetteur (id INT AUTO_INCREMENT NOT NULL, entreposage_id INT NOT NULL, transporteur_id INT NOT NULL, traitement_id INT NOT NULL, INDEX IDX_52127D6C2B60725 (entreposage_id), INDEX IDX_52127D697C86FA4 (transporteur_id), UNIQUE INDEX UNIQ_52127D6DDA344B6 (traitement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
